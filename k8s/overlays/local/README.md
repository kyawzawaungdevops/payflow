...
**Learning path:** Week 1 uses **`./scripts/deploy-microk8s.sh`** (applies this overlay). Week 2 explains *why* overlays exist—see [`LEARNING-PATH.md`](../../LEARNING-PATH.md) and the [MicroK8s deployment guide](https://osomudeya.gumroad.com/l/payflow).
...
Docker-Compose-only URL into the overlay and breaks all K8s environments.
...
- [MicroK8s deployment guide](https://osomudeya.gumroad.com/l/payflow) for the full local walkthrough
- `TROUBLESHOOTING.md` (repo root) for symptom → root cause → fix

---

**Done here? → Return to [`LEARNING-PATH.md`](../../LEARNING-PATH.md) and continue Week 2** (overlays + ingress day done—move to network policies, drills, or optional GitOps).
